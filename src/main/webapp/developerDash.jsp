	...
	<header class="header-section">
		<div class="container">
			...
			<div class="user-panel">
				<a href="developerlog.jsp">Login</a>  /  <a href="devRegister.jsp">Register</a>
			</div>
			<!-- responsive -->
	...
	<div class="latest-news-section">
		...
		<div class="news-ticker">
			<div class="news-ticker-contant">
				<div class="nt-item"><span class="new">new</span>We have determined the 20 Best Gaming Websites Websites based on the of traffic each website receives</div>
				<div class="nt-item"><span class="strategy">strategy</span>We have determined the 20 Best Gaming Websites Websites based on the of traffic each website receives </div>
				<div class="nt-item"><span class="racing">racing</span>We have determined the 20 Best Gaming Websites Websites based on the of traffic each website receives. </div>
			</div>
		</div>
	</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2>Our Community</h2>
						<p>
The customer is very important, the customer will be followed by the customer. Until then, the greatest mauris of the world, but there was no official website.</p>
					</div>
				</div>
			</div>
		</div>
					...
					<li>
						<div class="community-post">
							...
							<div class="post-content">
								...
								<p>We have determined the 20 Best Gaming Websites Websites based on the of traffic each website receives </p>
							</div>
						</div>
					</li>
					<li>
